...
def PAM_M2SQLR3_M2SQLAG1_tagging(objname, date_key, content):
    ...
    if objname == 'M2':
        ...
        # and al other backups expired after 740 days
        ...
        if time_between_last_modified.days > 122 :
            add_tag(content['Key'], 'PAM_M2SQLR3_M2SQLAG1_EXPIRATION', 'true')
        # expire all other Sunday(s) weekly backups after 2 months (62 days)
        elif date_key not in first_days_of_all_months_in_year and time_between_last_modified.days > 62:
            add_tag(content['Key'], 'PAM_M2SQLR3_M2SQLAG1_EXPIRATION', 'true')
...
def PAM_MACOLA_04_tagging(objname, date_key, content):
    ...
    if date_key not in last_days_of_all_months_in_year and time_between_last_modified.days > 62:
